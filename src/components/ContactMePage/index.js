...
class ContactMePage extends React.Component {
  ...
  renderSubmit(){
    ...
    return (
      <a href={`mailto:wfehrnstrom@gmail.com?subject=${subject}&body=${body}`}><Button style={{textTransform: 'none', marginTop: '40px', borderRadius: '2px'}}variant='outlined'>Submit</Button></a>
    )
  }
